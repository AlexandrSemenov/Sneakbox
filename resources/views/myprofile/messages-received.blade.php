...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-offset-1 col-md-10 wrapper" style="margin-top: 30px">
            <div>
                ...
                <div class="">
                    <div class="tab-pane message-tab active" style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd;">
                        <ul class="" style="margin-top: 20px;">
                            <li class="active"><a href="">Полученные</a></li>
                            <li><a href="{{route('messages.send')}}">Отправленные</a></li>
                        </ul>
